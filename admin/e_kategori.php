...
if (!$data) {
    echo "<script>alert('Data tidak ditemukan!'); window.location.href = 'ktg.php';</script>";
    exit;
}
...
<head>
    ...
    <title>Kategori - Martins-Clothing Admin</title>
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="ktg.php">

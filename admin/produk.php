...
<head>
    ...
    <title>Produk - Martins-Clothing Admin</title>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.php" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Martins-Clothing</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="assets/img/stalin.webp" alt="Profile" class="rounded-circle">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="e_produk.php?id=<?php echo $hasil['id_produk']; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                                                    <a href="h_produk.php?id=<?php echo $hasil['id_produk']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                        <?php
                                        ...
                                        ?>
                                        <tr>
                                            <tr><td colspan='9' class='text-center'>Belum ada data</td>
                                        </tr>
                                    <?php
                                    }
                                        ?>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Martins-Clothing</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            Designed by <a href="https://instagram.com/namaig/">Icad</a>
        </div>
    </footer><!-- End Footer -->
